...
class DataParallelPRIMERewardModel:
    ...
    def _forward_micro_batch(self, micro_batch, prompt_length):
        ...
        with torch.no_grad():
            # generalized estimation of r should go before the reward filling. r means process reward for policy model,
            # or the advantage of reward model.
            ...
            if lam == 0.0:
                ...
                # if we rely on outcome reward to calculate V
        ...
        for batch_idx, data in enumerate(dataloader):
            ...
            for data in micro_batches:
                ...
                if self.config.model.loss_type == "ce":
                    ...
                    # the implementation of dpo is actually detached, which means we have to know the average value
                    # of w/l reward before the update.
