...
def build_livecodebench_dataset():
    ...
    def process_livecodebench(example):
        ...
        if example["starter_code"]:
            query_prompt += (
                f"You will use the following starter code to write the solution to the problem and enclose your code "
            ...
            query_prompt += (
                ...
                "Enclose your code within delimiters as follows. Ensure that when the python program runs, "
                "it reads the inputs, "
