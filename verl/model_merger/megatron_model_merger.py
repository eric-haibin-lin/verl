...
class MegatronModelMerger(BaseModelMerger):
    ...
    def __init__(self, config: ModelMergerConfig):
        ...
        self.params_mapping = {
            ...
            # NOTICE: It's a little bit tricky, when 2 keys have the same prefix, we need to make sure the longer key 
            # within the containing relationship is processed first.
        ...
        for model_state_dict in model_state_dict_list:
            ...
            for key in keys:
                ...
                print(
                    ...
                    f"{split_tensor.shape if isinstance(split_tensor, torch.Tensor) else [t.shape for t in split_tensor]}"
                )
